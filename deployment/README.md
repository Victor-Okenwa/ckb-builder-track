...
offckb deploy --network devnet --target <contract-binary-path> --output /home/morse-code/projects/ckb-builder-track/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/morse-code/projects/ckb-builder-track/deployment
```
